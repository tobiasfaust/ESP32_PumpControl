...
function GetInitData() {
  ...
  data['cmd']['subaction'] = "valveconfig";
  data['cmd']['callbackFn'] = "valveconfig_Callback";
...
try {
  global.registerCallback('valveconfig_Callback', MyCallback);
} catch(e) { console.error('Callback Registrierung fehlgeschlagen (valveconfig):', e); }
